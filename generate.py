...
print("Daejeon+Sejong number of respondents: ", len(original_data))

daejeon = original_data[
    (original_data['home_province'] == '대전광역시')]
print("Daejeon number of respondents:", len(daejeon))
category_counts = daejeon['home_administrative'].value_counts()
print("Daejeon number of administrative districts: ", len(category_counts))

sejong = original_data[
    (original_data['home_province'] == '세종특별자치시')]
print("Sejong number of respondents:", len(sejong))
category_counts = sejong['home_administrative'].value_counts()
print("Sejong number of administrative districts: ", len(category_counts))
